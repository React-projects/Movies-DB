...
function MoviesDetails() {
  ...
  const moviesDetails = async () => {
    const res = await axios.get(
      `https://api.themoviedb.org/3/movie/${params.id}?api_key=a5b028967ab8251416e6ad7347bbe6cf&language=ar`
    );
    setMovie(res.data);
    ...
    <div>
      ...
      <Row className="justify-content-center">
        <Col md="12" xs="12" sm="12" className="mt-1 ">
          <div className="card-story  d-flex flex-column align-items-center">
